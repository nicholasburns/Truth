...
if (not C["Chat"]["Enable"] or not C["Chat"]["Channels"])
	then return
end
...
local s = ("%s%s|"):format(L["BN_IN"], closetag)

--------------------------------------------------
--	Players Channels
--------------------------------------------------
CHAT_BN_WHISPER_GET			= format("%s%s", L["B<"], "%s:\32")							-- CHAT_BN_WHISPER_GET = L["BN_IN"]  .. "%s:\32"
CHAT_BN_WHISPER_INFORM_GET	= format("%s%s", L["B>"], "%s:\32")							-- CHAT_BN_WHISPER_INFORM_GET = L["BN_OUT"] .. "%s:\32"
