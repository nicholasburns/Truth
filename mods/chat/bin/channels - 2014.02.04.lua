...
if (not C["Chat"]["Channels"]) then return end
...
--------------------------------------------------
local closetag = "%s:\32"
local closelink = "|h%s:\32"

local s = format("%s%s", L["BN_IN"], closetag)

--------------------------------------------------
--	Players Channels
--------------------------------------------------
CHAT_BN_WHISPER_GET			= format("%s%s", L["BN_IN"], "%s:\32")							-- CHAT_BN_WHISPER_GET = L["BN_IN"]  .. "%s:\32"
CHAT_BN_WHISPER_INFORM_GET	= format("%s%s", L["BN_OUT"], "%s:\32")							-- CHAT_BN_WHISPER_INFORM_GET = L["BN_OUT"] .. "%s:\32"

CHAT_GUILD_GET 			= format("%s%s%s", "|Hchannel:GUILD|h", L["G"], "|h%s:\32")			-- CHAT_GUILD_GET = "|Hchannel:GUILD|h"   .. L["G"]  .. "|h%s:\32"
CHAT_OFFICER_GET 			= format("%s%s%s", "|Hchannel:OFFICER|h", L["O"], "|h%s:\32")		-- CHAT_OFFICER_GET = "|Hchannel:OFFICER|h" .. L["O"]  .. "|h%s:\32"

CHAT_INSTANCE_CHAT_GET  		= "|Hchannel:INSTANCE_CHAT|h"	.. L["I"]  .. "|h%s:\32"
CHAT_INSTANCE_CHAT_LEADER_GET = "|Hchannel:INSTANCE_CHAT|h"	.. L["IL"] .. "|h%s:\32"

CHAT_PARTY_GET 			= "|Hchannel:PARTY|h" .. L["P"]  .. "|h%s:\32"
CHAT_PARTY_GUIDE_GET 		= "|Hchannel:PARTY|h" .. L["PG"] .. "|h%s:\32"
...
CHAT_RAID_WARNING_GET 		= format("%s%s", L["RW"], "%s:\32")							-- CHAT_RAID_WARNING_GET = L["RW"] .. "%s:\32"

CHAT_WHISPER_GET  			= format("%s%s", L["W_IN"], "%s:\32")							-- CHAT_WHISPER_GET = L["W_IN"]  .. "%s:\32"
CHAT_WHISPER_INFORM_GET  	= format("%s%s", L["W_OUT"], "%s:\32")							-- CHAT_WHISPER_INFORM_GET = L["W_OUT"] .. "%s:\32"

CHAT_SAY_GET  				= format("%s%s", L["S"], "%s:\32")								-- CHAT_SAY_GET = L["S"] .. "%s:\32"
CHAT_YELL_GET  			= format("%s%s", L["BN_IN"], "%s:\32")							-- CHAT_YELL_GET = L["Y"] .. "%s:\32"

CHAT_FLAG_AFK  			= "[|cffE7E716" .. L["AFK"] .. "|r]\32"
CHAT_FLAG_DND  			= "[|cffFF0000" .. L["DND"] .. "|r]\32"
...
--[[	L["BN_IN"]  = "B"	-- BNet
	...
	L["AFK"] = "[AFK]"
	L["DND"] = "[DND]"
	L["ONLINE"] = "has come |cff298F00online|r"
	L["OFFLINE"] = "has gone |cffff0000offline|r"
--]]
